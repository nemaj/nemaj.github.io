...
/* harmony import */ var _shared_components_modals_confirmation__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @shared/components/modals/confirmation */ "./src/app/shared/components/modals/confirmation/index.ts");
/* harmony import */ var _shared_services_modal_modal_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @shared/services/modal/modal.service */ "./src/app/shared/services/modal/modal.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AddFundsBannerComponent = /** @class */ (function () {
    function AddFundsBannerComponent(_dragAndDropService, bsModalService, _currentUserService, _modalService) {
        var _this = this;
    ...
    AddFundsBannerComponent.prototype.showAddFundsModal = function (e) {
        ...
        if (!isAccreditedInvestor) {
            this.openWarningForNonAccredited();
            return;
        }
    ...
    AddFundsBannerComponent.prototype.openWarningForNonAccredited = function () {
        var props = {
            status: 'warning',
            title: 'Sorry, our offer isn’t quite ready for Non Accredited Investors',
            desc: "We hope to have this offer available to all investors by\n      August 2019 - we will be in touch with you to confirm availability.",
            buttonLabel: 'Got it'
        };
        this._modalService.modalInstance(_shared_components_modals_confirmation__WEBPACK_IMPORTED_MODULE_6__["ConfirmationComponent"], {
    ...
    AddFundsBannerComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_shared_services_drag_and_drop_drag_and_drop_service__WEBPACK_IMPORTED_MODULE_5__["DragAndDropService"],
            ...
            _shared_services_modal_modal_service__WEBPACK_IMPORTED_MODULE_7__["ModalService"]])
...
/* harmony import */ var _pages_my_properties_my_properties_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./pages/my-properties/my-properties.component */ "./src/app/modules/dashboard/pages/my-properties/my-properties.component.ts");
/* harmony import */ var _shared_components_my_profile_my_profile_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @shared/components/my-profile/my-profile.component */ "./src/app/shared/components/my-profile/my-profile.component.ts");
/* harmony import */ var _pages_book_to_stay_book_to_stay_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./pages/book-to-stay/book-to-stay.component */ "./src/app/modules/dashboard/pages/book-to-stay/book-to-stay.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        ...
        children: [
            ...
            {
                path: 'properties',
                component: _pages_my_properties_my_properties_component__WEBPACK_IMPORTED_MODULE_5__["MyPropertiesComponent"],
                data: {
            ...
            {
                path: 'wallet',
                component: _pages_wallet_wallet_component__WEBPACK_IMPORTED_MODULE_4__["WalletComponent"],
                data: {
            ...
            {
                path: 'my-profile',
                component: _shared_components_my_profile_my_profile_component__WEBPACK_IMPORTED_MODULE_6__["MyProfileComponent"],
                data: {
            ...
            {
                path: 'book-to-stay',
                component: _pages_book_to_stay_book_to_stay_component__WEBPACK_IMPORTED_MODULE_7__["BookToStayComponent"],
                data: {
                    pageTitle: 'Partbnb - Book To Stay',
                    pageName: 'Book To Stay'
                }
            }
            // {
            //   path: 'details',
            //   component: PreorderDashboardComponent,
            //   data: { pageTitle: 'Partbnb - My Dashboard' }
            // },
...
var MyPropertiesComponent = /** @class */ (function () {
    function MyPropertiesComponent(router, title, bsModalService, plaidLinkService, _currentUser, _dashboardProperties, _proertyService, _walletShared, _general, _modalService) {
        this.router = router;
        this.title = title;
        this.bsModalService = bsModalService;
    ...
    MyPropertiesComponent.prototype.openWarningForNonAccredited = function () {
        var props = {
            status: 'warning',
            title: 'Sorry, our offer isn’t quite ready for Non Accredited Investors',
            desc: "We hope to have this offer available to all investors by\n      August 2019 - we will be in touch with you to confirm availability.",
        ...
        this._modalService.modalInstance(_shared_components_modals_confirmation__WEBPACK_IMPORTED_MODULE_4__["ConfirmationComponent"], {
            initialState: { props: props },
            animated: false,
            class: 'confirmation'
        });
...
/* harmony import */ var _shared_constants_verification_status__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @shared/constants/verification-status */ "./src/app/shared/constants/verification-status.ts");
/* harmony import */ var _shared_components_modals_confirmation__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @shared/components/modals/confirmation */ "./src/app/shared/components/modals/confirmation/index.ts");
/* harmony import */ var _shared_components_modals_investor_verification_investor_verification_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @shared/components/modals/investor-verification/investor-verification.component */ "./src/app/shared/components/modals/investor-verification/investor-verification.component.ts");
/* harmony import */ var _shared_services_modal_modal_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @shared/services/modal/modal.service */ "./src/app/shared/services/modal/modal.service.ts");
/* harmony import */ var _shared_components_modals_withdraw_funds_withdraw_funds_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @shared/components/modals/withdraw-funds/withdraw-funds.component */ "./src/app/shared/components/modals/withdraw-funds/withdraw-funds.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var WalletComponent = /** @class */ (function () {
    function WalletComponent(title, bsModalService, _wallet, _walletShared, _currentUser, _modalService) {
        this.title = title;
        this.bsModalService = bsModalService;
    ...
    WalletComponent.prototype.addFund = function () {
        var _this = this;
        var _a = this._currentUser.getUserInfo(), verificationStatus = _a.verificationStatus, isAccreditedInvestor = _a.isAccreditedInvestor;
        if (!isAccreditedInvestor) {
            this.openWarningForNonAccredited();
            return;
        }
        if (verificationStatus === _shared_constants_verification_status__WEBPACK_IMPORTED_MODULE_6__["VERIFICATION_STATUS"].APPROVED) {
            ...
            var props = {
                ...
                title: 'You need to be verified as an Accredited Investor',
                desc: "We need to verify your status as an Accredited Investor before you can proceed.",
                isButtonDisabled: verificationStatus === _shared_constants_verification_status__WEBPACK_IMPORTED_MODULE_6__["VERIFICATION_STATUS"].PENDING || false,
                buttonLabel: verificationStatus === _shared_constants_verification_status__WEBPACK_IMPORTED_MODULE_6__["VERIFICATION_STATUS"].PENDING
                    ? 'Verification Pending'
                    : 'Start Verification'
            };
            var modalRef = this._modalService.modalInstance(_shared_components_modals_confirmation__WEBPACK_IMPORTED_MODULE_7__["ConfirmationComponent"], {
                initialState: { props: props },
                animated: false,
                class: 'confirmation'
            });
    ...
    WalletComponent.prototype.openWarningForNonAccredited = function () {
        var props = {
            status: 'warning',
            title: 'Sorry, our offer isn’t quite ready for Non Accredited Investors',
            desc: "We hope to have this offer available to all investors by\n      August 2019 - we will be in touch with you to confirm availability.",
        ...
        this._modalService.modalInstance(_shared_components_modals_confirmation__WEBPACK_IMPORTED_MODULE_7__["ConfirmationComponent"], {
            initialState: { props: props },
            animated: false,
            class: 'confirmation'
        });
    };
    WalletComponent.prototype.openInvestorVerify = function () {
        this._modalService.modalInstance(_shared_components_modals_investor_verification_investor_verification_component__WEBPACK_IMPORTED_MODULE_8__["InvestorVerificationComponent"], {
            ignoreBackdropClick: true,
            class: 'modal-lg'
        });
    };
    ...
    WalletComponent.prototype.withdrawFund = function () {
        var _this = this;
        var modalRef = this.bsModalService.show(_shared_components_modals_withdraw_funds_withdraw_funds_component__WEBPACK_IMPORTED_MODULE_10__["WithdrawFundsComponent"], {
            initialState: {
    ...
    WalletComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["Title"],
            ...
            _shared_services_modal_modal_service__WEBPACK_IMPORTED_MODULE_9__["ModalService"]])
    ], WalletComponent);
